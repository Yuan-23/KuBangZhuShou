...
public class SearchView extends LinearLayout {
    ...
    String[] titles_category = { "运动健身","在线教育", "美容美妆","精品农业", "其他"};
    String[] titles_hot = { "小学","西瓜", "英语"};
    ...
    private HorizontalListView mHorizontalListView_1;
    private HorizontalListViewAdapter mHorizontalListViewAdapter_1;
    private HorizontalListView mHorizontalListView_2;
    private HorizontalListViewAdapter mHorizontalListViewAdapter_2;
    ...
    private void init() {
        ...
        et_search.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {
                    ...
                    if (!(mCallBack == null)) {
                        mCallBack.SearchAction(et_search.getText().toString(), 1);
                    }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               /* if (!(mCallBack == null)){
                    mCallBack.SearchAction(name,1);
                }*/
            }
        });
        mHorizontalListView_1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //et_search.setText(name);
                if (!(mCallBack == null)) {
                    mCallBack.SearchAction(name, position + 1);
                }
                mHorizontalListViewAdapter_1.notifyDataSetChanged();

            }
        });
        mHorizontalListView_2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //et_search.setText(name);
                if (!(mCallBack == null)) {
                    mCallBack.SearchAction(titles_hot[position], type);
                }
                mHorizontalListViewAdapter_2.notifyDataSetChanged();
    ...
    private void initView(){
        ...
        //7.横向Listview：热门搜索和分类搜索

        mHorizontalListView_1 = (HorizontalListView) findViewById(R.id.horizontal_lv_1);
        mHorizontalListViewAdapter_1 = new HorizontalListViewAdapter(context,titles_category);
        mHorizontalListView_1.setAdapter(mHorizontalListViewAdapter_1);
        mHorizontalListView_2 = (HorizontalListView) findViewById(R.id.horizontal_lv_2);
        mHorizontalListViewAdapter_2 = new HorizontalListViewAdapter(context,titles_hot);
        mHorizontalListView_2.setAdapter(mHorizontalListViewAdapter_2);
